// const { doc, setDoc, getDoc } = require('firebase/firestore'); // Deshabilitado para navegador
// const CryptoJS = require('crypto-js'); // Comentada para evitar error en navegador
